...
# pickle.dump(train, open('train_classification_set.pkl', 'wb'))
# pickle.dump(test, open('test_classification_set.pkl', 'wb'))
...
# model.fit_generator(generator(train), epochs=50, steps_per_epoch=math.ceil(num_training_samples / batch_size), 
					# validation_data=generator(test), validation_steps=math.ceil(num_test_samples / batch_size))
# model.save('models_classification/inception.h5')
...
# filepath = 'models_classification/resnet_full.h5'
...
pickle.dump(history.accs, open('models_classification/resnet_full_history_accs.pkl', 'wb'))
pickle.dump(history.losses, open('models_classification/resnet_full_history_losses.pkl', 'wb'))

model.save('models_classification/resnet_full_trained.h5')
results = model.evaluate_generator(generator(test), steps=math.ceil(num_test_samples / batch_size), verbose=1)
pickle.dump(results, open('resnet_full_res.pkl', 'wb'))
print (results)
