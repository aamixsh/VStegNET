# -*- coding: utf-8 -*-
"""
Created on Mon Jul 30 12:04:47 2018

@author: Suraj
"""
import tensorflow as tf

def hiding_network(cover, secret):
    with tf.variable_scope('hide_net'):

        concat_input = tf.concat([cover, secret],  axis = 1, name='concat')
        #print(concat_input)

        conv1 = tf.layers.conv3d(concat_input,32,3,padding='same',name="1",activation=tf.nn.relu,data_format='channels_last')  
        ...
        print(v1)
        v1 = tf.layers.conv3d(v1,32,3,padding='same',name = '6', activation=tf.nn.relu,data_format='channels_last')
        # print(v1)
        ...
        v2 = tf.layers.conv3d(conv2,64,3,padding='same',name = '12', activation=tf.nn.relu,data_format='channels_last')
        ...
        v3 = tf.layers.conv3d(conv3,128,3,padding='same',name = '18', activation=tf.nn.relu,data_format='channels_last')
        ...
        v4 = tf.layers.conv3d(conv4,256,3,padding='same',name = '24', activation=tf.nn.relu,data_format='channels_last')
        
       
        maxpool4 = tf.layers.max_pooling3d(conv4, (1,2,2), strides=(1,2,2), data_format='channels_last')
        print(maxpool4)
        conv5 = tf.layers.conv3d(maxpool4,512,3,padding='same',name="25",activation=tf.nn.relu,data_format='channels_last')  
        ...
        conv5 = tf.layers.conv3d(conv5,512,3,padding='same',name="29",activation=tf.nn.relu,data_format='channels_last')
        #print(conv5)
        #print(conv5)
       ...
       # upsample1 = conv3dTranspose(filters=256,kernel_size=3, padding='same', activation=tf.nn.relu,data_format='channels_last', data_format='channels_last')(upsample1)
        ...
        conv6 = tf.layers.conv3d(concat1,256,3,padding='same',name="30",activation=tf.nn.relu,data_format='channels_last')  
        ...
        conv6 = tf.layers.conv3d(conv6,256,3,padding='same',name="34",activation=tf.nn.relu,data_format='channels_last')
        #print(conv6)
        ...
        conv7 = tf.layers.conv3d(concat2,128,3,padding='same',name="35",activation=tf.nn.relu,data_format='channels_last')  
        ...
        conv7 = tf.layers.conv3d(conv7, 128,3,padding='same',name="39",activation=tf.nn.relu,data_format='channels_last')
        #print(conv7)
        ...
        conv8 = tf.layers.conv3d(concat3,64,3,padding='same',name="40",activation=tf.nn.relu,data_format='channels_last')  
        ...
        conv8 = tf.layers.conv3d(conv8,64,3,padding='same',name="44",activation=tf.nn.relu,data_format='channels_last')
        #print(conv8)
        ...
        conv9 = tf.layers.conv3d(concat4,32,3,padding='same',name="45",activation=tf.nn.relu,data_format='channels_last')  
        ...
        conv9 = tf.layers.conv3d(conv9,32,3,padding='same',name="48",activation=tf.nn.relu,data_format='channels_last') 
        output = tf.layers.conv3d(conv9,3,3,padding='same',name="49",activation=tf.nn.sigmoid)
        # print("\n\n\nhiding output shape : ",output,"\n\n\n")
        # print("Hiding_Net")
        return output
